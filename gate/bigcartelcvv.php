...
$shop_data = "https://woodbyhannah.bigcartel.com";
$store_url = parse_url($shop_data, PHP_URL_HOST);

$item_list = [329662854, 329662857, 329662860, 335739375, 335739378, 335739381, 335740527, 335740530, 335740533];
...
$post_data = [
    ...
    "shipping_address_1" => "49 Wrexham Road",
    "shipping_address_2" => "",
    "shipping_city" => "FENCE HOUSES",
    "shipping_state" => "GBE",
    "shipping_zip" => "DH4 1QG",
